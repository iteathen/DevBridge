...
test('Ubuntu Hyper-V fcopy capability is one sealed UIO adapter with exact qualification', () => {
  ...
  assert.equal(selected.files[0].path, '/etc/systemd/system/hv-fcopy-daemon.service.d/10-devbridge-uio.conf');
