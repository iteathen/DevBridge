...
const SYNTAX_FILES = [
  ...
  'src/setup/windows-installer-evidence-prerequisite.js',
  ...
  'scripts/build-source-bundle-release.mjs',
  'scripts/build-ubuntu-package-capsule-release.mjs',
  'scripts/build-ubuntu-package-capsule-production.mjs',
  'scripts/prepare-ubuntu-capsule-solver-inputs.mjs',
  'src/bootstrap/standalone-artifact.mjs',
  'src/bootstrap/standalone-source-loader.mjs',
  'src/runtime/conditional-item-set.js',
  'src/install/permanent-entry-components.mjs',
  'src/install/permanent-entry-installer.mjs',
  'src/install/permanent-entry-inventory.js',
  ...
  'src/entry/runner-cache-inventory-source.mjs',
  'src/entry/runner-cache-inventory.mjs',
  'src/entry/runner-cache-ownership.mjs',
  'src/entry/stable-entry.mjs',
  'src/install/permanent-entry-installer/input-contract.mjs',
  'src/install/permanent-entry-installer/ownership-state.mjs',
  ...
  'src/bootstrap/source-bundle-release-input.mjs',
  'src/bootstrap/source-bundle-materialization.mjs',
  'src/bootstrap/source-bundle-availability.mjs',
  'src/bootstrap/git-bundle-checkout.mjs',
  'src/runtime/immutable-object-acquisition-evidence.js',
  'src/runtime/immutable-object-pack.js',
  'src/release/git-source-bundle-producer.mjs',
  'src/release/source-bundle-release-builder.mjs',
  'src/release/immutable-object-file-publisher.mjs',
  'src/release/immutable-release-publication-gate.mjs',
  'src/release/github-release-destination.mjs',
  'src/release/s3-request-signature.mjs',
  ...
  'src/runtime/image-builders/ubuntu-installation-basis.js',
  'src/release/ubuntu-package-capsule-capture.mjs',
  'src/release/ubuntu-package-capsule-producer.mjs',
  'src/release/ubuntu-snapshot-archive-https-source.mjs',
  'src/release/ubuntu-snapshot-apt-lists.mjs',
  'src/release/ubuntu-package-capsule-capture-verifier.mjs',
  'src/release/ubuntu-package-capsule-release-builder.mjs',
  'src/cli.js',
  'src/config.js',
  'src/app/runtime.js',
  ...
  'src/state/exclusive-mutation.js',
  'src/state/json-record-file.js',
  'src/state/revisioned-record-state-store.js',
  ...
  'src/app/environment-recovery.js',
  'src/app/setup.js',
  ...
  'src/app/windows-elevated-setup-environment-activation.js',
  ...
  'src/runtime/local-authority-socket-connection.js',
  ...
  'src/setup/ubuntu-package-capsule-availability.mjs',
  'src/setup/ubuntu-package-repository.mjs',
  'src/setup/ubuntu-package-capsule-release-input.mjs',
  'src/setup/resource-conflict.js',
  'src/setup/operational-configuration.js',
  'src/setup/path-installation.js',
  'src/setup/path-visibility.js',
  'src/setup/setup-progress.js',
  'src/setup/setup-protected-apply-frontier.js',
  ...
  'src/app/setup-lifecycle-authority.js',
  ...
  'src/setup/linux-cli-authenticated-entry.js',
  'src/setup/linux-cli-authentication-origin.js',
  'src/setup/linux-cli-authentication.js',
  'src/setup/current-principal-observation.js',
  'src/setup/local-principal-observation.js',
  ...
  'src/setup/linux-lifecycle-authority-readiness.js',
  'src/setup/linux-setup-lifecycle-authority.js',
  'src/setup/linux-local-state-identity.js',
  'src/setup/linux-ordinary-access-boundary.js',
  ...
  'src/setup/protected-operation-dispatcher.js',
  'src/setup/protected-readiness-reconciliation.js',
];
...
const TARGETED_TESTS = [
  ...
  'test/permanent-entry-ownership-state.test.js',
  'test/conditional-item-set.test.js',
  'test/publication-ownership-lego.test.js',
  ...
  'test/source-bundle-release-input.test.js',
  'test/source-bundle-materialization.test.js',
  'test/source-bundle-release-builder.test.js',
  'test/immutable-object-acquisition-evidence.test.js',
  'test/immutable-object-pack.test.js',
  'test/immutable-release-publication-gate.test.js',
  'test/github-release-destination.test.js',
  'test/r2-release-destination.test.js',
  'test/ubuntu-apt-transaction-solver.test.js',
  'test/ubuntu-capsule-solver-input-preparer.test.js',
  'test/ubuntu-installer-layer-entry-source.test.js',
  'test/ubuntu-installation-basis.test.js',
  'test/ubuntu-package-capsule-capture.test.js',
  'test/ubuntu-package-capsule-producer.test.js',
  'test/ubuntu-snapshot-archive-https-source.test.js',
  'test/ubuntu-snapshot-apt-lists.test.js',
  'test/ubuntu-package-capsule-availability.test.js',
  'test/ubuntu-package-repository.test.js',
  'test/ubuntu-package-capsule-release-input.test.js',
  'test/ubuntu-package-capsule-release-builder.test.js',
  'test/config.test.js',
  ...
  'test/application-removal.test.js',
  'test/application-removal-lego.test.js',
  'test/application-removal-journal.test.js',
  'test/application-removal-source.test.js',
  'test/bound-effect-actions.test.js',
  'test/exact-artifact-receipt-lego.test.js',
  'test/exact-artifact-receipt.test.js',
  'test/exact-artifact-inventory-lego.test.js',
  'test/exact-artifact-inventory.test.js',
  'test/exact-value-inventory.test.js',
  'test/permanent-entry-inventory-source.test.js',
  'test/permanent-entry-candidate-staging.test.js',
  'test/permanent-entry-experimental-checkout.test.js',
  'test/permanent-entry-runner-provider.test.js',
  'test/permanent-entry-stable-entry.test.js',
  'test/runner-cache-inventory.test.js',
  'test/runner-cache-ownership.test.js',
  'test/exact-directory.test.js',
  'test/exact-artifact-set.test.js',
  'test/revisioned-record-state-store.test.js',
  'test/revisioned-record-state-store-lego.test.js',
  ...
  'test/local-authority-socket-connection.test.js',
  ...
  'test/linux-lifecycle-authority-readiness.test.js',
  'test/linux-ordinary-access-boundary.test.js',
  'test/protected-readiness-reconciliation.test.js',
  ...
  'test/linux-cli-authenticated-entry.test.js',
  'test/linux-cli-authentication-origin.test.js',
  'test/linux-cli-authentication.test.js',
  'test/current-principal-observation.test.js',
  'test/linux-setup-lifecycle-authority.test.js',
  'test/linux-lifecycle-authority-endpoint-topology.test.js',
  'test/protected-operation-dispatcher.test.js',
  ...
  'test/setup-architecture.test.js',
  'test/setup-path-installation.test.js',
  'test/setup-path-visibility.test.js',
  'test/setup-progress.test.js',
  'test/setup-protected-apply-frontier.test.js',
  'test/setup.test.js',
  ...
  'test/windows-elevated-setup-environment-activation.test.js',
  ...
  'test/windows-installer-evidence-prerequisite.test.js',
