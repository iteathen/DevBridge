...
const SYNTAX_FILES = [
  ...
  'src/context/chat-handoff/value-contract.js',
  'src/context/chat-handoff/record-contract.js',
  'src/context/chat-handoff/pointer-contract.js',
  'src/context/chat-handoff/retention-policy.js',
  'src/context/chat-handoff/store-transaction.js',
