...
import { createEnvironmentLifecycleDiagnostics } from '../runtime/environment-lifecycle-diagnostics.js';
...
export function createEnvironmentLifecycle({ stateDirectory, now, operationId } = {}) {
  ...
  return Object.freeze({
    ...
    diagnostics: createEnvironmentLifecycleDiagnostics({ port: port.diagnostics, ...(now ? { now } : {}) }),
  });
}
