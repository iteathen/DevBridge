...
export function normalizeWindowsProductionImageAuthority(raw) {
  ...
  if (!['audit-handoff-v1', 'audit-handoff-v2', 'audit-handoff-v3'].includes(recipe.generation)) throw new TypeError('production image recipe generation is unsupported');
