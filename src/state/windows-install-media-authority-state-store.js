...
export function createWindowsInstallMediaAuthorityStateStore(filePath) {
  if (typeof filePath !== 'string' || filePath.length === 0) throw new TypeError('install media authority state file is required');
