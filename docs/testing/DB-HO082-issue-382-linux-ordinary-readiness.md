...
Status: implementation planned on branch `stage8/362-protected-activity-channel` from accepted #381 documentation head `a9d1b3d9f44671930cd86f7aa908a24746601a33`.
